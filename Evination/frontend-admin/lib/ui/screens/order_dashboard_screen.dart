    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Header
            Text('Order Management', style: AppTheme.heading.copyWith(fontSize: 28)),
            const SizedBox(height: 8),
            Text('Track and manage all event-related orders', style: TextStyle(color: Colors.grey[600])),
            const SizedBox(height: 24),
            
            // Stats Row
            Row(
              children: [
                _StatCard(title: 'Total Orders', value: '${stats['total']}', icon: Icons.inventory_2_outlined, color: Colors.amber),
                const SizedBox(width: 16),
                _StatCard(title: 'Pending', value: '${stats['pending']}', icon: Icons.schedule, color: Colors.orange),
                const SizedBox(width: 16),
                _StatCard(title: 'Completed', value: '${stats['completed']}', icon: Icons.check_circle_outline, color: Colors.green),
                const SizedBox(width: 16),
                _StatCard(title: 'Total Value', value: '₹${(stats['totalValue']/1000).toStringAsFixed(0)}K', icon: Icons.attach_money, color: Colors.blue),
              ],
            ),
            const SizedBox(height: 24),
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
             ...
             Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                ...
                ElevatedButton.icon(
                   ...
                   style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFFDB913)),
                )
             ]),
          ]),
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                   ShaderMask(shaderCallback: (r) => const LinearGradient(colors: [Color(0xFFFDB913), Color(0xFFE5A711)]).createShader(r), child: const Text('Order Details', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white))),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                   ...
                   const SizedBox(width: 16),
                   ElevatedButton(onPressed: (){}, style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFFDB913), foregroundColor: Colors.white), child: const Text('Download Invoice')),
                ],
              ),
            ),
          ],
...
class _InfoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
         Row(children: [Icon(icon, color: const Color(0xFFFDB913)), const SizedBox(width: 8), Text(title, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16))]),
         const SizedBox(height: 16),
