      ...
      builder: (context, constraints) {
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // Header
              Text('Settings', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: AppTheme.emeraldGreen)),
  ...
  Widget _buildTabItem(Map<String, dynamic> tab, bool isVertical) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive ? AppTheme.emeraldGreen : Colors.transparent,
          borderRadius: BorderRadius.circular(12),
        ),
        child: Row(
          children: [
        ...
        Row(
          children: [
            Container(
              ...
              height: 80,
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [AppTheme.emeraldGreen, AppTheme.darkEvergreen]),
