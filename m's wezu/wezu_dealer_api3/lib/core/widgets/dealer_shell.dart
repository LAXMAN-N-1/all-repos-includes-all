              ...
              child: Container(
                ...
                child: Center(
                  child: AnimatedRotation(
                    ...
                    duration: const Duration(milliseconds: 200),
                    child: const Icon(LucideIcons.chevronsLeft,
...
class _NavItemState extends State<_NavItem> {
  ...
  bool get _isActive {
    final normalizedCurrentPath = widget.currentPath.split('?').first;
    if (widget.exactMatch) {
      return normalizedCurrentPath == widget.path;
    }
    return normalizedCurrentPath == widget.path ||
        normalizedCurrentPath.startsWith('${widget.path}/');
  }
        ...
        child: Tooltip(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              height: 40,
              padding:
                  EdgeInsets.symmetric(horizontal: widget.collapsed ? 12 : 10),
              decoration: BoxDecoration(
                color: _isActive
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Padding(
      ...
      child: PopupMenuButton<String>(
        ...
        child: Container(
          padding:
              EdgeInsets.symmetric(horizontal: collapsed ? 6 : 8, vertical: 8),
          decoration: BoxDecoration(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(user?.userType ?? 'Dealer Admin',
                          style: const TextStyle(
...
class _Topbar extends StatelessWidget {
      ...
      child: Row(
        children: [
          ...
          AnimatedContainer(
            duration: const Duration(milliseconds: 200),
            width: isMobile
                ? (searchFocused ? 120 : 36)
                : (searchFocused ? 320 : 200),
            height: 36,
            child: TextField(
  ...
  String _getPageTitle(String uri) {
    ...
    if (uri.startsWith('/battery-requests')) return 'Battery Requests';
    ...
    if (uri.startsWith('/settings/swap-fee')) return 'Swap Fee';
