...
import '../../features/inventory/screens/request_batteries_screen.dart';
import '../../features/sales/screens/sales_screen.dart';
import '../../features/customers/screens/customers_screen.dart';
import '../../features/tickets/screens/tickets_screen.dart';
import '../../features/settings/screens/settings_screen.dart';
import '../../features/settings/screens/swap_fee_screen.dart';
...
import '../../features/operations/screens/swap_history_screen.dart';
    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          // Operations — Swap History
          GoRoute(
            path: '/operations/swaps',
            name: 'operations-swap-history',
            builder: (context, state) => const SwapHistoryScreen(),
          ),
          ...
          GoRoute(
            ...
            name: 'battery-requests',
            builder: (context, state) => const RequestBatteriesScreen(),
          ),
          GoRoute(
            path: '/operations/request-batteries',
            redirect: (context, state) => '/battery-requests',
          ),
          GoRoute(
            path: '/inventory/operations/request-batteries',
            redirect: (context, state) => '/battery-requests',
          ),
          ...
          GoRoute(
            ...
            routes: [
              GoRoute(
                path: 'swap-fee',
                name: 'swap-fee',
                builder: (context, state) => const SwapFeeScreen(),
              ),
            ],
          ),
          GoRoute(
