...
class _DocumentsScreenState extends ConsumerState<DocumentsScreen>
  ...
  String _formatIsoDate(String? iso, {required String fallback}) {
  ...
  Widget build(BuildContext context) {
    ...
    final expiringSoon = docs.where((d) {
      ...
      final exp = DateTime.tryParse(d.validUntil!)?.toLocal();
  ...
  Widget _buildDocumentDetailPanel(dynamic d) {
    ...
    final sColor = statusUpper == 'VERIFIED'
        ...
        : statusUpper == 'PENDING'
            ? AppColors.amber
            : AppColors.red;
    final validStr = d.validUntil != null
        ? _formatIsoDate(d.validUntil, fallback: 'Permanent')
        : 'Permanent';
