            ...
            child: ListView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text('OPERATIONS', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.textMuted, letterSpacing: 1.2)),
                ),

                _NavItem(
                  icon: LucideIcons.refreshCw,
                  label: 'Live Swaps',
                  isSelected: currentRoute == '/stations/swaps',
                  onTap: () => context.go('/stations/swaps'),
                  accentColor: AppColors.cyan,
                ),
                _NavItem(
                  icon: LucideIcons.history,
                  label: 'Swap History',
                  isSelected: currentRoute.startsWith('/operations/swaps'),
                  onTap: () => context.go('/operations/swaps'),
                  accentColor: AppColors.cyan,
                ),
