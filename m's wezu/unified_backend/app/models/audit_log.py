...
class AuditLog(SQLModel, table=True):
    ...
    target_table: Optional[str] = Field(default=None, index=True)
    ...
    old_state: Optional[Dict[str, Any]] = Field(
        default=None, sa_column=Column("old_state", JSON, nullable=True)
    )
    new_state: Optional[Dict[str, Any]] = Field(
        default=None, sa_column=Column("new_state", JSON, nullable=True)
    )
