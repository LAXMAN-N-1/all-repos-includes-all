...
@router.post("/top-ups", response_model=DataResponse[dict])
...
@router.post("/withdraw", response_model=DataResponse[dict]) # Return basic dict or WithdrawalRequest model if schema defined
...
async def request_withdrawal(
    ...
    """Use when submitting bank details for the first withdrawal request."""
    try:
        bank_details = {
        ...
        return DataResponse(
            ...
            data={"status": "success", "request_id": wr.id},
        )
