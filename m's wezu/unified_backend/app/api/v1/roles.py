...
def create_role(
    *,
    ...
    role_in: RoleCreate,
    current_user = Depends(deps.require_permission("roles:create"))
):
...
def update_role(
    *,
    ...
    role_id: int,
    role_in: RoleUpdate,
    current_user = Depends(deps.require_permission("roles:edit"))
):
...
def delete_role(
    *,
    db: Session = Depends(deps.get_db),
    role_id: int,
    current_user = Depends(deps.require_permission("roles:delete"))
):
