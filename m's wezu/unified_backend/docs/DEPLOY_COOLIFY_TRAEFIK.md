...
SUPABASE_ALLOWED_ALGORITHMS=ES256,RS256
...
- Keep `SUPABASE_SERVICE_ROLE_KEY` server-side only. It is required for admin
  user creation through Supabase Admin Auth and must never be shipped in the
  frontend app.
