    ...
    while (true) {
      ...
      if (remaining.inHours <= 24 && remaining.inHours > 23 && !_notified24h) {
        _sendFormattedNotification(
          rentalId,
          'Swap Reminder: Your rental expires in 24h. Nearby swap stations are available.',
      ...
      if (remaining.inHours <= 12 && remaining.inHours > 11 && !_notified12h) {
        _sendFormattedNotification(
          rentalId,
          'Plan a Swap: 12h remaining. Open the app to view nearest swap stations.',
          NotificationType.rental,
        );
        _notified12h = true;
      }
      ...
      if (remaining.inMinutes <= 60 &&
        ...
        _sendFormattedNotification(
          rentalId,
          'FINAL REMINDER: 1h left! Fast-track swap is available at nearby stations.',
          NotificationType.rental,
        );
        _notified1h = true;
      }
