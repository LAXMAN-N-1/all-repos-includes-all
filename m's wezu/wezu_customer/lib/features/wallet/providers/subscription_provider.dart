...
class SubscriptionState {
  ...
  SubscriptionState copyWith({
    Object? activeSubscription = _unset,
    ...
    return SubscriptionState(
      activeSubscription: identical(activeSubscription, _unset)
          ? this.activeSubscription
          : activeSubscription as Subscription?,
      plans: plans ?? this.plans,
      isLoading: isLoading ?? this.isLoading,
      error: identical(error, _unset) ? this.error : error as String?,
      lastPurchase: identical(lastPurchase, _unset)
          ? this.lastPurchase
          : lastPurchase as SubscriptionPurchaseResponse?,
    );
  }
}
