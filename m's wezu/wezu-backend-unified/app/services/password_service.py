...
class PasswordService:
    ...
    def is_password_expired(user: User) -> bool:
        ...
        if user.password_changed_at is None:
            ...
            if created_at:
                return (now_utc - created_at).days > PASSWORD_EXPIRY_DAYS
            return False
        password_changed_at = ensure_utc_aware(user.password_changed_at)
        if password_changed_at is None:
            return False
        return (now_utc - password_changed_at).days > PASSWORD_EXPIRY_DAYS
