...
from app.api.v1 import (
    auth, customer_auth, sessions, users, kyc, stations, batteries,
    rentals, bookings, wallet, payments, support, favorites, analytics,
...
app.add_middleware(
    ...
    # Keep explicit origin checks and allow any request headers for resilience
    # across frontend apps (dealer/customer/logistics/admin).
    allow_headers=["*"],
    expose_headers=["*"],
)
