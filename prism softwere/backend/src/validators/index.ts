...
export const createProjectValidation = [
    ...
    body('leadId').optional({ nullable: true }).isUUID().withMessage('Valid lead ID is required'),
...
export const createIssueValidation = [
    ...
    body('description').optional().trim(),
    body('type').isIn(Object.values(IssueType).filter((value) => value !== IssueType.EPIC)).withMessage('Invalid issue type'),
...
export const updateIssueValidation = [
    ...
    body('description').optional().trim(),
    body('type').optional().isIn(Object.values(IssueType).filter((value) => value !== IssueType.EPIC)),
