...
class User extends Model<UserAttributes, UserCreationAttributes> implements UserAttributes {
    ...
    public readonly attendanceRecords?: Attendance[];
    public readonly leaveRequests?: LeaveRequest[];

    public static associations: {
        employeeDetails: Association<User, EmployeeDetails>;
        attendanceRecords: Association<User, Attendance>;
        leaveRequests: Association<User, LeaveRequest>;
    };
