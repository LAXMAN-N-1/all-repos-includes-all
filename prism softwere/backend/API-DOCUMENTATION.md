...
### Getting a Token
1. Login with an existing user to get access and refresh tokens
...
- `POST /projects/:projectId/files` - Upload project file
- `GET /projects/:projectId/files/:fileId/download` - Download project file
- `DELETE /projects/:projectId/files/:fileId` - Delete project file

### Issues
- `GET /issues` - List issues (with filters)
- `GET /issues/:id` - Get issue details
- `POST /issues` - Create issue (`type=EPIC` is rejected; use `/epics`)
- `PUT /issues/:id` - Update issue (`type=EPIC` is rejected; use `/epics`)
- `DELETE /issues/:id` - Delete issue
- `POST /issues/create-story` - Create story in an epic
- `POST /issues/create-subtask` - Create sub-task under an issue
- `PUT /issues/:id/move-to-sprint` - Move issue to sprint
