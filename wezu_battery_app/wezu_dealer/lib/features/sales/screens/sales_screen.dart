          ...
          children: [
              ...
              Expanded(child: Container(
                ...
                child: Row(children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    const Text('Total Transactions', style: TextStyle(fontSize: 11, color: AppColors.textTertiary)),
                  ]),
                ]),
              )),
              const Spacer(),
            ...
            _stagger(2, child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      : salesState.transactions.isEmpty
                        ...
                        : SingleChildScrollView(scrollDirection: Axis.horizontal, child: DataTable(
                            ...
                            columns: const [
                              ...
                              DataColumn(label: Text('DATE & TIME', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11))),
                            ...
                            rows: salesState.transactions.take(15).map((tx) {
                              ...
                              return DataRow(
                                ...
                                onSelectChanged: (_) => setState(() => _selectedTransaction = tx),
                                cells: [
              ...
              if (_selectedTransaction != null) ...[
                ...
                Expanded(flex: 2, child: _buildTransactionDetailPanel(_selectedTransaction!, currency)),
              ],
            ])),
          ],
        ),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(padding: const EdgeInsets.all(18), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 10),
          _infoRow('Description', tx.description ?? 'No description'),
          const SizedBox(height: 24),
