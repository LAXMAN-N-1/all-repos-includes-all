...
class SwapPortModals {
  ...
  static void showActiveSwapModal(BuildContext context, SwapPortDto port, String stationName, {VoidCallback? onComplete}) {
    final elapsed = port.swapStartedAt != null
        ? DateTime.now().difference(DateTime.parse(port.swapStartedAt!))
        : Duration.zero;
      ...
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _infoRow('Swap Started', port.swapStartedAt != null
              ? _formatTime(DateTime.parse(port.swapStartedAt!))
              : '—', LucideIcons.clock),
      ...
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (port.lastUsedAt != null)
            _infoRow('Last Used', _timeAgo(DateTime.parse(port.lastUsedAt!)), LucideIcons.clock),
