...
class _WalletScreenState extends ConsumerState<WalletScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(walletProvider.notifier).refreshAll());
  }
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    'Valid until ${offer.expiryDate.day}/${offer.expiryDate.month}/${offer.expiryDate.year}',
                    style:
              ...
              children: [
                Text(txn.description,
                    style: TextStyle(
                        ...
                        fontSize: 14)),
                Text(
                  '${txn.date.day}/${txn.date.month} · ${txn.method.name.toUpperCase()}',
                  style: const TextStyle(
