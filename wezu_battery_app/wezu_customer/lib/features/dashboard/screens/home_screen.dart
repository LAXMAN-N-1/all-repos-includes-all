...
class _HomeScreenState extends ConsumerState<HomeScreen> {
      ...
      child: PageView(
        ...
        children: [
          _buildStatsCard(
            ...
            stats != null && stats.activeRentals > 0 ? "View rentals" : "No active rentals",
  ...
  Widget _buildRentalCard(BuildContext context, String type, String station,
    ...
    return GestureDetector(
      ...
      child: Container(
        width: Responsive.horizontalCardWidth(context, mobileRatio: 0.75, maxWidth: 340),
  ...
  Widget _buildStationCard(Station station) {
    ...
    return GestureDetector(
      ...
      child: Container(
        width: Responsive.horizontalCardWidth(context, mobileRatio: 0.6, maxWidth: 280),
        margin: const EdgeInsets.only(right: 16),
        decoration: BoxDecoration(
          color: Theme.of(context).cardColor,
          borderRadius: BorderRadius.circular(20),
